  ...
  if window.v then
    ...
    imgui.BeginGroup()
      imgui.BeginChild('question', imgui.ImVec2(sw / 16, sh / 1.62), true)
        if imgui.ButtonActivated(tab == 1, u8('Ñêóï'), imgui.ImVec2(sw / 21.2, sh / 15)) then menu = 2 tab = 1 end
        if imgui.ButtonActivated(tab == 2, u8('Ïðîäàæà'), imgui.ImVec2(sw / 21.2, sh / 15)) then menu = 3 tab = 2 end
        if imgui.ButtonActivated(tab == 3, u8('Íàñòðîéêè'), imgui.ImVec2(sw / 21.2, sh / 15)) then menu = 4 tab = 3 end
        imgui.Separator()
        if imgui.Button(u8('Âûõîä'), imgui.ImVec2(sw / 21.2, sh / 15)) then window.v = not window.v end
      imgui.EndChild()
    imgui.EndGroup()
          ...
          if menu == 2 then
            imgui.BeginGroup()
              imgui.BeginChild('choiceBuyMain', imgui.ImVec2(sw / 3.96, sh / 12), true)
                ...
                if imgui.Button(u8('Îáíîâèòü ñïèñîê òîâàðîâ'), imgui.ImVec2(sw / 4.23, sh / 40)) then
                  sms('Äëÿ òîãî, ÷òîáû íà÷àòü îáíîâëÿòü ñïèñîê òîâàðîâ íà ñêóï - íàæìèòå alt ó ëàâêè è æäèòå')
                  mode = 1
                end
                if imgui.Button(u8('Îáíîâèòü ñðåäíèå öåíû'), imgui.ImVec2(sw / 4.23, sh / 40)) then

                end
              imgui.EndChild()
              imgui.BeginChild('choiceBuy', imgui.ImVec2(sw / 3.96, sh / 2), true)
                local choiceBuy = imgui.InputTextWithHint("## buffer", u8"Íàçâàíèå", bufferSearch[1])
                imgui.Text(u8('Â ñïèñêå ïðåäìåòîâ: %s'):format(#choiceBuyArray))
                imgui.Separator()
          ...
          if menu == 3 then
            imgui.BeginGroup()
              imgui.BeginChild('choiceSellMain', imgui.ImVec2(sw / 3.96, sh / 12), true)
                if imgui.Button(u8('Îáíîâèòü ñïèñîê òîâàðîâ'), imgui.ImVec2(sw / 4.23, sh / 40)) then
                  sms('Äëÿ òîãî, ÷òîáû íà÷àòü îáíîâëÿòü ñïèñîê òîâàðîâ íà ïðîäàæó - íàæìèòå alt ó ëàâêè è æäèòå')
                  mode = 6
                end
                if imgui.Button(u8('Îáíîâèòü ñðåäíèå öåíû'), imgui.ImVec2(sw / 4.23, sh / 40)) then
              ...
              imgui.BeginChild('choiceSell', imgui.ImVec2(sw / 3.96, sh / 2), true)
                local choiceSell = imgui.InputTextWithHint("## buffer", u8"Íàçâàíèå", bufferSearch[2])
                imgui.Text(u8('Â ñïèñêå ïðåäìåòîâ: %s'):format(#choiceSellArray))
                imgui.Separator()
          ...
          if menu == 2 then
            imgui.BeginGroup()
              imgui.BeginChild('myBuyMain', imgui.ImVec2(sw / 3.96, sh / 12), true)
                if imgui.Button(u8('Îñíîâíîé'), imgui.ImVec2(sw / 4.23, sh / 40)) then
                  
                end
                if imgui.Button(u8('Ïî îñòàòêó'), imgui.ImVec2(sw / 13.4, sh / 40)) then
                  
                end
                imgui.SameLine()
                if imgui.Button(u8('Ñíÿòü'), imgui.ImVec2(sw / 13.4, sh / 40)) then
                  sms('Äëÿ òîãî, ÷òîáû íà÷àòü ñíèìàòü òîâàð ñî ñêóïà - íàæìèòå alt ó ëàâêè è æäèòå')
                  mode = 4
                end
                imgui.SameLine()
                if imgui.Button(u8('Âûñòàâèòü'), imgui.ImVec2(sw / 13.4, sh / 40)) then
                  sms('Äëÿ òîãî, ÷òîáû íà÷àòü âûñòàâëÿòü òîâàð íà ñêóï - íàæìèòå alt ó ëàâêè è æäèòå')
                  mode = 3
                end
              imgui.EndChild()
              imgui.BeginChild('myBuy', imgui.ImVec2(sw / 3.96, sh / 2), true)
                local myBuy = imgui.InputTextWithHint("## buffer", u8"Íàçâàíèå", bufferSearch[3])
                imgui.Text(u8('Â ñïèñêå ïðåäìåòîâ: %s'):format(#myBuyArray))
                imgui.SameLine()
                calcPriceBuy()
                imgui.Separator()
          ...
          if menu == 3 then
            imgui.BeginGroup()
              imgui.BeginChild('mySellMain', imgui.ImVec2(sw / 3.96, sh / 12), true)
                ...
                imgui.SameLine()
                if imgui.Button(u8('Ñíÿòü'), imgui.ImVec2(sw / 13.4, sh / 40)) then
                  sms('Äëÿ òîãî, ÷òîáû íà÷àòü ñíèìàòü òîâàð ñ ïðîäàæè - íàæìèòå alt ó ëàâêè è æäèòå')
                  mode = 20
                end
                imgui.SameLine()
                if imgui.Button(u8('Âûñòàâèòü'), imgui.ImVec2(sw / 13.4, sh / 40)) then
                  sms('Äëÿ òîãî, ÷òîáû íà÷àòü âûñòàâëÿòü òîâàð íà ïðîäàæó - íàæìèòå alt ó ëàâêè è æäèòå')
                  pagesell = 1
                  mode = 8
                end
              imgui.EndChild()
              imgui.BeginChild('mySell', imgui.ImVec2(sw / 3.96, sh / 2), true)
                local mySell = imgui.InputTextWithHint("## buffer", u8"Íàçâàíèå", bufferSearch[4])
                imgui.Text(u8('Â ñïèñêå ïðåäìåòîâ: %s'):format(#mySellArray))
                imgui.SameLine()
                calcPriceSell()
                imgui.Separator()
    ...
    if menu == 4 then
      imgui.BeginGroup()
        imgui.BeginChild('settings', imgui.ImVec2(sw / 1.845, sh / 1.62), true)
          imgui.Text(u8('Íàçâàíèå: %s\nÂåðñèÿ: %s\nÀâòîð: %s\n\nÊîìàíäà äëÿ îòêðûòèÿ ñêðèïòà: %s'):format(__name__, __version__, u8(__author__), u8('/'..ini.main.command)))
          imgui.Text(u8('moonloader // config // AutoBuySell - ïóòü íàñòðîåê.\nmybuy.json - ñêóï ïðåäìåòîâ (1: íàçâàíèå, 2: êîëè÷åñòâî, 3: öåíà, 4: àêòèâèðîâàíî ëè)\nchoicebuy.json - âûáîð ïðåäìåòà íà ñêóï (1: íàçâàíèå)\nmysell.json - ïðîäàæà ïðåäìåòîâ (1: íàçâàíèå, 2: êîëè÷åñòâî, 3: öåíà, 4: àêòèâèðîâàíî ëè)\nchoicesell.json - âûáîð ïðåäìåòà äëÿ ïðîäàæó (1: íàçâàíèå, êîëè÷åñòâî)\nAbsSettings.ini - íàñòðîéêè (1: íàçâàíèå, 2: çíà÷åíèå)'))
          imgui.Text(' ')
          settingsmaincmd()
          kdmaincmd()
          autosellbuy()
...
function main()
  ...
  sms('Author Kline.' .. ' Àêòèâàöèÿ /' .. ini.main.command)
...
function sampev.onServerMessage(color, text)
  lua_thread.create(function ()
    if text:find("Èñïîëüçóéòå êëàâèøó: 'Äåéñòâèÿ' äëÿ óïðàâëåíèÿ òîâàðàìè!") and text:find('[Ïîäñêàçêà]') and color == -89368321 then
      wait(500)
      sampAddChatMessage(('{32CD32}AutoBuySell - äëÿ òîãî, ÷òîáû îòêðûòü ìåíþ ââåäèòå êîìàíäó /%s'):format(ini.main.command), -1)
      wait(500)
...
function sampev.onShowDialog(id, style, title, button1, button2, text)
  ...
  local page = {title:match('Ñòðàíèöà (%d+)/(%d+)')}

  if mode == 1 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    lua_thread.create(function ()
      choiceBuyArray = {}
      jsonSave(json_file_choicebuyarray,choiceBuyArray)
      wait(ini.main.delaybuy)
      sampSendDialogResponse(id, 1, getLineOnTextDialog(text, 'Äîáàâèòü òîâàð íà ïîêóïêó'), nil)
      mode = 2
    end)
  end

  if mode == 2 and text:find('Ñêóïàåòå') and text:find('Ñëåäóþùàÿ ñòðàíèöà >>>') and page[1] ~= page[2] then
    lua_thread.create(function ()
      wait(ini.main.delaybuy)
      local size = sampGetListboxItemsCount()-1
      local rightpage = sampGetListboxItemsCount()-1
      for i = 0, size, 1 do
        if sampGetListboxItemText(i) ~= 'Ñëåäóþùàÿ ñòðàíèöà >>>' and sampGetListboxItemText(i) ~= '<<< Ïðåäûäóùàÿ ñòðàíèöà' then
  ...
  if mode == 2  and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    mode = 1
  end
  ...
  if mode == 2 and text:find('Ñêóïàåòå') and text:find('Ñëåäóþùàÿ ñòðàíèöà >>>') and page[1] == page[2] then
    lua_thread.create(function ()
      ...
      sms('Îáíîâëåíèÿ ñïèñêà òîâàðîâ íà ñêóï çàâåðøåí!')
    end)
  end

  if mode == 3 and #myBuyArray <= 0 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    sms('Ñïèñîê òîâàðîâ íà ñêóï ïóñòîé!')
    mode = 0
  end

  if mode == 3 and #myBuyArray > 0 and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') then
    lua_thread.create(function ()
      ...
      if imyBuyArray == nil or imyBuyArray > #myBuyArray then
        ...
        sms('Âûñòàâëåíèå òîâàðîâ íà ñêóï çàâåðøåí!')
      else
        wait(ini.main.delaybuy)
        sampSendDialogResponse(id, 1, getLineOnTextDialog(text, 'Äîáàâèòü òîâàð íà ïîêóïêó %(ïîèñê ïî ïðåäìåòàì%)'), nil)
      end
    end)
  end

  if mode == 3 and #myBuyArray > 0 and not text:find('Óäàëèòü òîâàð ñ ïðîäàæè') and not text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') then
    lua_thread.create(function()
      if text:find('Ââåäèòå íàèìåíîâàíèå òîâàðà, êîòîðûé õîòèòå íàéòè è âûñòàâèòü íà ñêóïêó.') and #myBuyArray > 0 then
        wait(ini.main.delaybuy)
        sampSendDialogResponse(id, 1, nil, myBuyArray[imyBuyArray][1])
      end
      if title:find('Ïîèñê òîâàðà') and not text:find('Ââåäèòå íàèìåíîâàíèå òîâàðà, êîòîðûé õîòèòå íàéòè è âûñòàâèòü íà ñêóïêó.') and #myBuyArray > 0 then
        wait(ini.main.delaybuy)
        local text = text:gsub('{......}', '')
        local text = text:gsub('%d.','')
        sampSendDialogResponse(id, 1, 0, nil)
      end
      if text:find('Ââåäèòå öåíó çà òîâàð') and #myBuyArray > 0 then
        wait(ini.main.delaybuy)
        sampSendDialogResponse(id, 1, nil, myBuyArray[imyBuyArray][3])
        imyBuyArray = imyBuyArray + 1
      end
      if text:find('Ââåäèòå êîëè÷åñòâî è öåíó çà îäèí òîâàð')and #myBuyArray > 0 then
        wait(ini.main.delaybuy)
  ...
  if mode == 4 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    lua_thread.create(function ()
      wait(ini.main.delaybuy)
      sampSendDialogResponse(id, 1, getLineOnTextDialog(text, 'Ïðåêðàòèòü ïîêóïêó òîâàðà'), nil)
      mode = 5
    end)
  end

  if mode == 5 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    mode = 0
    sms('Ïðåêðàùåíèå ñêóïà òîâàðîâ çàâåðøåí!')
  end

  if mode == 5 and text:find('Ñêóïàåòå') and text:find('Ñëåäóþùàÿ ñòðàíèöà >>>') then
    lua_thread.create(function ()
      local size = sampGetListboxItemsCount()-1
      local rightpage = sampGetListboxItemsCount()-1
  ...
  if mode == 6 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    lua_thread.create(function ()
      choiceSellArray = {}
      jsonSave(json_file_choicesellarray,choiceSellArray)
      wait(ini.main.delaysell)
      sampSendDialogResponse(id, 1, getLineOnTextDialog(text, 'Âûñòàâèòü òîâàð íà ïðîäàæó'), nil)
      mode = 7
    end)
  end

  if mode == 7 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    mode = 6
  end

  if mode == 7 and text:find('Â ïðîäàæå') and text:find('Ñëåäóþùàÿ ñòðàíèöà >>>') and page[1] ~= page[2] then
    lua_thread.create(function ()
      for line in text:gmatch('[^\n]+') do
        if line:find('.+') and not line:find('Â íàëè÷èè') and not line:find('Ïðåäûäóùàÿ ñòðàíèöà') and not line:find('Ñëåäóþùàÿ ñòðàíèöà') then
          if line:find('{777777}') then
            local namebad = line:match('{777777}.+{777777}')
            local nameb = namebad:gsub('{......}','')
            local name = nameb:gsub('%s+$','')
            if line:find('{777777}(%d+) øò%.') then
      ...
      wait(ini.main.delaysell)
      sampSendDialogResponse(id, 1, getLineOnTextDialog(text, 'Ñëåäóþùàÿ ñòðàíèöà')-1, nil)
    end)
  end

  if mode == 7 and text:find('Â ïðîäàæå') and text:find('Â íàëè÷èè') and page[1] == page[2] then
    lua_thread.create(function ()
      for line in text:gmatch('[^\n]+') do
        if line:find('.+') and not line:find('Â íàëè÷èè') and not line:find('Ïðåäûäóùàÿ ñòðàíèöà') and not line:find('Ñëåäóþùàÿ ñòðàíèöà') then
          if line:find('{777777}') then
      ...
      sms('Îáíîâëåíèÿ ñïèñêà òîâàðîâ íà ïðîäàæó çàâåðøåí!')
    end)
  end

  if mode == 8 and #mySellArray <= 0 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    sms('Ñïèñîê òîâàðîâ íà ïðîäàæó ïóñòîé')
    mode = 0
  end
  ...
  if mode == 8 and #mySellArray > 0 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    lua_thread.create(function ()
      ...
      if pagesell == nil or pagesell > #mySellArray then
        sms('Âûñòàâëåíèå òîâàðîâ íà ïðîäàæó çàâåðøåí!')
        pagesell = 1
        mode = 0
      else
        wait(ini.main.delaysell)
  ...
  if mode == 9 and #mySellArray > 0 and text:find('Ïðåäûäóùàÿ ñòðàíèöà') and page[1] ~= page[2] then
    lua_thread.create(function ()
      local massive = {}
      local name = nil
      local dd = 0
      ...
      for i, line in ipairs(massive) do
        if line:find('.+') and not line:find('Â íàëè÷èè') and not line:find('Ïðåäûäóùàÿ ñòðàíèöà') and not line:find('Ñëåäóþùàÿ ñòðàíèöà') and mode == 9 then
          if line:find('{777777}') then
            local namebad = line:match('{777777}.+{777777}')
            local nameb = namebad:gsub('{......}','')
  ...
  if mode == 11 and text:find('Ââåäèòå êîëè÷åñòâî è öåíó çà îäèí òîâàð') then
    lua_thread.create(function ()
      wait(ini.main.delaysell)
  ...
  if mode == 11 and text:find('Ââåäèòå öåíó çà òîâàð') then
    lua_thread.create(function ()
      wait(ini.main.delaysell)
  ...
  if mode == 20 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    lua_thread.create(function ()
      wait(ini.main.delaysell)
      sampSendDialogResponse(id, 1, getLineOnTextDialog(text, 'Óäàëèòü òîâàð ñ ïðîäàæè'), nil)
      mode = 21
    end)
  end

  if mode == 21 and text:find('Ïðåêðàòèòü ïîêóïêó òîâàðà') and text:find('Óäàëèòü òîâàð ñ ïðîäàæè') then
    mode = 0
    sms('Ïðåêðàùåíèå ïðîäàæè òîâàðîâ çàâåðøåí!')
  end

  if mode == 21 and text:find('Â ïðîäàæå') and text:find('Ñëåäóþùàÿ ñòðàíèöà >>>') then
    lua_thread.create(function ()
      local size = sampGetListboxItemsCount()-1
      local rightpage = sampGetListboxItemsCount()-1
      if text:find('{67BE55}.+') then
...
function calcPriceBuy()
  ...
  if calcMyMoneyMyBuy > -1 then
    ...
    imgui.Text(u8('%s$ íåõâàòàåò'):format(calcMyMoneyMyBuy1))
  end
end
...
function settingsmaincmd()
  ...
  imgui.PushItemWidth(100)
    if imgui.InputText(u8('Êîìàíäà äëÿ îòêðûòèÿ ñêðèïòà (áåç ñëåøà / )'), buffer) then
...
function kdmaincmd()
  ...
  imgui.PushItemWidth(100)
    if imgui.InputInt(u8('Çàäåðæêà ìåæäó îêíàìè ïðè ñêóïå (ëó÷øå íå òðîãàòü)'), bufferbuy, 0, 0) then
      if u8:decode(bufferbuy.v) ~= ini.main.delaybuy and bufferbuy.v > 0 then
        ini.main.delaybuy = u8:decode(bufferbuy.v)
        inicfg.save(ini, IniFilename)
      end
    end
    if imgui.InputInt(u8('Çàäåðæêà ìåæäó îêíàìè ïðè ïðîäàæå (ëó÷øå íå òðîãàòü)'), buffersell, 0, 0) then
...
function funcmybuy(i, data, sw, sh)
  ...
  imgui.SameLine()
  if imgui.ButtonActivated(tab1 == i, u8('##Ïåðåìåñòèòü ##%d'):format(i), imgui.ImVec2(sh / 40, sh / 40)) then
    if tab1 == 0 then
      tab1 = i
    else
  ...
  imgui.SameLine()
  if imgui.Button(u8'Ñáðîñèòü ##%d':format(i), imgui.ImVec2(sw / 30, sh / 40)) then
    tab1 = 0
  end
  imgui.SameLine()
  imgui.Text(u8('%s - %s'):format(i, u8(data[1])))
  imgui.SameLine()
  if imgui.Button(u8('Óäàëèòü ##%d'):format(i), imgui.ImVec2(sw / 33 , sh / 40)) and myBuyArray[i] then
...
function funcmysell(i, data, sw, sh)
  ...
  imgui.SameLine()
  if imgui.ButtonActivated(tab2 == i, u8('##Ïåðåìåñòèòüd ##%d'):format(i), imgui.ImVec2(sh / 40, sh / 40)) then
    if tab2 == 0 then
      tab2 = i
    else
  ...
  imgui.Text(u8('%s - %s'):format(i,u8(data[1])))
  imgui.SameLine()
  if imgui.Button(u8('Óäàëèòü ##%d'):format(i), imgui.ImVec2(sw / 33 , sh / 40)) and data[1] then
    table.remove(mySellArray, i)
    tab2 = 0
    jsonSave(json_file_mysellarray,mySellArray)
  end
  imgui.Text(u8('%s øò'):format(data[2]))
...
function funcchoicesell(i, data, sw, sh)
  if imgui.Button(u8('%s - %s - %s øò'):format(i,u8(data[1]),data[2]), imgui.ImVec2(sw / 4.3 , sh / 40)) then
...
function autosellbuy()
  ...
  if imgui.Checkbox(u8'Àâòî âûñòàâëåíèå òîâàðîâ íà ñêóï ïîñëå òîãî, êàê âñòàëè â ëàâêó', autobuyparam) then
  ...
  imgui.SameLine()
  if imgui.Checkbox(u8'Àâòî âûñòàâëåíèå òîâàðîâ íà ïðîäàæó ïîñëå òîãî, êàê âñòàëè â ëàâêó', autosellparam) then
